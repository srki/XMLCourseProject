...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" font-family="Athena">
            ...
            <fo:page-sequence master-reference="act">
                <fo:flow flow-name="xsl-region-body">
                    <fo:block font-weight="normal" text-align="center">
                        <fo:external-graphic src="img/novi-sad-logo.png" content-height="30mm" />
                    </fo:block>
